...
func (s *baseTestSuite) SetupTest() {
	s.accessKey = "testAccessKey"
	s.secretKey = "testSecretKey"
	s.client = newMockedClient(s.accessKey, s.secretKey)
}
...
func newMockedClient(accessKey, secretKey string) *mockedClient {
	m := new(mockedClient)
	m.Client = NewClient(accessKey, secretKey)
	return m
}
